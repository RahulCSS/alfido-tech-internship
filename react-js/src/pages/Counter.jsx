...
const Counter = () => {
  ...
  return (
    <div class="flex flex-col justify-center items-center min-h-screen">
      <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center text-blue-600">Counter App</div>
      <div class="flex flex-col justify-center items-center gap-[1rem] h-[200px] w-[400px]">
        <div class="flex gap-[1rem]">
          ...
          <span class="text-[1.5rem]">{count}</span>
